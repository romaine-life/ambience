...
func TestDevPageEffectFromPath(t *testing.T) {
	cases := []struct {
		...
		{path: "/dev/magic-portal", want: "magic-portal", wantOK: true},
		{path: "/dev/paper-lanterns", want: "paper-lanterns", wantOK: true},
...
func TestEffectFromSchemaPath(t *testing.T) {
	cases := []struct {
		...
		{path: "/effects/magic-portal/schema", want: "magic-portal", wantOK: true},
		{path: "/effects/paper-lanterns/schema", want: "paper-lanterns", wantOK: true},
